...
def filter_by_currency(list_transaction: list[dict[str, Any]], currency = "USD") -> Generator[Any, Any, Any]:
...
def transaction_descriptions(list_transactions: list[dict[str, Any]]) -> Generator[Any, Any, Any]:
